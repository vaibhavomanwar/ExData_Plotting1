...
# create the plots to study how household energy usage varries
png(file = "plot4.png")
par(mfrow = c(2,2))
...
plot(dateTime, subdata$Global_reactive_power, ylab = "Global_reactive_power", type = 'l', xlab = "datetime")
dev.off()